//! The TFT source: Riot's competetft.com (RSC) + the official published Google
//! Sheet (CSV). Produces `crate::tft`'s session model, plus
//! streamer/broadcast/lobby extras. Server-only.
